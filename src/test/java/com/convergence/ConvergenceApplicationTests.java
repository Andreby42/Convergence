...
public class ConvergenceApplicationTests {
    ...
    /**
     * 1、mockMvc.perform 执行一个请求。 2、MockMvcRequestBuilders.get("XXX") 构造一个请求。
     * 3、ResultActions.andExpect 添加执行完成后的断言。 4、ResultActions.andDo 添加一个结果处理器，表示要对结果做点什么事情 比如此处使用
     * MockMvcResultHandlers.print() 输出整个响应结果信息。 5、ResultActions.andReturn 表示执行完成后返回相应的结果。
     */
    @Test
