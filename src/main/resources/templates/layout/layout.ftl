...
<div class="wrapper">
    ...
    <header class="main-header">
        ...
        <a href="../../index2.html" class="logo">
            ...
            <span class="logo-lg"><b>KRONOS</b></span>
        </a>
    ...
    <aside class="main-sidebar">
        ...
        <section class="sidebar">
            ...
            <@shiro.hasPermission name="system:user:index">
                <li <#if active=="user">class="active"</#if>><a href="${ctx!}/user/index"><i class="fa fa-user-o"></i>
                    用户管理</a></li>
            </@shiro.hasPermission>
            <@shiro.hasPermission name="system:role:index">
                <li <#if active=="role">class="active"</#if>><a href="${ctx!}/role/index"><i
