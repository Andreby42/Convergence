    ...
    <div class="row">
        <div class="col-md-10">
            ...
            <div class="box  box-primary">
                <form class="form-horizontal form-edit" method="post" action="${ctx!}/user/edit">
                    <div class="box-body">
                        <input type="hidden" id="id" name="userId" value="${user.userId?c}">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input id="birthday" name="birthday" class="laydate-icon form-control layer-date"
                                       value="${user.birthday?string('yyyy-MM-dd HH:mm:ss')}">
                            </div>
                        </div>
                        <div class="form-group">
