...
public class UserDTO implements Serializable {
    ...
    public String toString() {
        return "UserDTO [userId=" + userId + ", birthday=" + birthday + ", createTime=" + createTime
                + ", status=" + status + ", description=" + description + ", email=" + email
                + ", locked=" + locked + ", nickName=" + nickName + ", password=" + password
                + ", sex=" + sex + ", telephone=" + telephone + ", updateTime=" + updateTime
